...
print('reading dump')
with open('data/geoengineering/topics_finn/dump_monthly.json', 'r') as f:
    dump = json.load(f)

print('reading labels')
labels = np.load('data/geoengineering/topics_finn.npy')
...
with open('data/geoengineering/topics_finn/dump_geo_finn.json', 'w') as f:
    json.dump(dump, f)
